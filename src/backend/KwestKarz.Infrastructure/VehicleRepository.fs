...
type PostgresVehicleRepository(dataSource: NpgsqlDataSource) =
    ...
    let mapVehicle (reader: NpgsqlDataReader) =
        { Id = reader.GetGuid(reader.GetOrdinal("id"))
          ...
          BodyClass = getOption reader "body_class" reader.GetString
          Transmission = getOption reader "transmission" reader.GetString
          ...
          TuroListingUrl = getOption reader "turo_listing_url" reader.GetString
    ...
    let selectColumns =
        ...
        current_odometer, current_odometer_recorded_at, fleet_position_number, notes, description,
    ...
    let addVehicleParameters (command: NpgsqlCommand) (vehicle: NewVehicle) (id: Guid) (now: DateTimeOffset) =
        ...
        command.Parameters.AddWithValue("body_class", NpgsqlDbType.Text, optionOrDbNull vehicle.BodyClass) |> ignore
        command.Parameters.AddWithValue("transmission", NpgsqlDbType.Text, optionOrDbNull vehicle.Transmission) |> ignore
        ...
        command.Parameters.AddWithValue("turo_listing_url", NpgsqlDbType.Text, optionOrDbNull vehicle.TuroListingUrl) |> ignore
        ...
        command.Parameters.AddWithValue("description", NpgsqlDbType.Text, optionOrDbNull vehicle.Description) |> ignore
    ...
    interface IVehicleRepository with
        ...
        member _.UpdateAsync(id: Guid, update: UpdateVehicle, cancellationToken: CancellationToken) : Task<Vehicle option> =
            task {
                ...
                use command =
                    new NpgsqlCommand(
                        ...
                        update kwestkarzbusinessdata.vehicles set
                            ...
                            status = @status,
                            turo_listing_url = @turo_listing_url,
                ...
                command.Parameters.AddWithValue("id", NpgsqlDbType.Uuid, id) |> ignore
                command.Parameters.AddWithValue("body_class", NpgsqlDbType.Text, optionOrDbNull update.BodyClass) |> ignore
                command.Parameters.AddWithValue("transmission", NpgsqlDbType.Text, optionOrDbNull update.Transmission) |> ignore
                ...
                command.Parameters.AddWithValue("turo_listing_url", NpgsqlDbType.Text, optionOrDbNull update.TuroListingUrl) |> ignore
                ...
                command.Parameters.AddWithValue("description", NpgsqlDbType.Text, optionOrDbNull update.Description) |> ignore
                command.Parameters.AddWithValue("updated_at", NpgsqlDbType.TimestampTz, now) |> ignore
