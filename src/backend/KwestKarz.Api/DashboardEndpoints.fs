...
module DashboardEndpoints =
    let mapDashboardEndpoints (app: WebApplication) =
        app.MapGet(
            ...
            Func<Guid, IVehicleRepository, IMaintenanceRepository, IDocumentRepository, HttpContext, Task<IResult>>(fun vehicleId vehicles maintenance documents httpContext ->
                task {
